...
if (!databaseUrl) {
    throw new Error("DATABASE_URL is not set. Add a connection string (mysql:// or postgresql://) to .env, or set the individual DB_HOST/DB_USER/DB_PASSWORD/DB_NAME parameters");
}
