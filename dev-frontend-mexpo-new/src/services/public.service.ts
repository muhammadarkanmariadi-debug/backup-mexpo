...
export async function getEvents(query?: QueryEntity) {

    const params: Record<string, string> = {};
    if (query?.page != null) params.page = String(query.page);
    if (query?.quantity != null) params.limit = String(query.quantity);
...
export async function getMyEvents(query?: QueryEntity) {
